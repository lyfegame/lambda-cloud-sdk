...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("LAMBDACLOUDSDK_USERNAME"):
        security_dict["username"] = os.getenv("LAMBDACLOUDSDK_USERNAME")

    if os.getenv("LAMBDACLOUDSDK_PASSWORD"):
        security_dict["password"] = os.getenv("LAMBDACLOUDSDK_PASSWORD")
